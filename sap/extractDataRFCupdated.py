...
def fetch_table(table, fields, options=[], row_count=100000):
...
while True:
    for batch in material_list[start:end]:
        # opts = [""]
        # opts = {
        #     'TEXT': f"MATNR: {}"
        # }
...
# for mat in filtered_materials:
opts = ["BWKEY LIKE '5%'"]
mbew_df = fetch_table("MBEW", tables["MBEW"], options=opts)
